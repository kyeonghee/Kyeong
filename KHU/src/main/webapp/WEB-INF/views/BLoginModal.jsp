...
<script type="text/javascript">
	var DormCheck=function(){
		if(!Dormform.studentNum.value){
			alert('아이디를 입력하세요');
			Dormform.studentNum.focus();
			return;
		}
		if(!Dormform.studentPwd.value){
			alert('비밀번호를 입력하세요');
			Dormform.studentPwd.focus();
			return;
		}
		Dormform.submit();
	}
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form name="Dormform" action="<%=myctx%>/Dorm/DormLogin" method="post">
					<table class="table table-borderless">
						...
						<tr>
							...
							<td colspan="2" class="text-right">
								<button type="button" onclick="DormCheck()"
