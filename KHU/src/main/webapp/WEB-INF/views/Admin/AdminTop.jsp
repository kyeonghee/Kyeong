...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbar-ex-collapse">
				...
				<c:if test="${adminUser==null}">
					...
					<c:if test="${adminUser!=null}">
					<li class="bg-warning"><a>${adminUser.adminName}님 로그인중...</a></li>
					<li><a href="<%=myctx%>/ALogout">Logout</a></li>
				</c:if>
					<li><a href="<%=myctx%>/Admin/AdminPage">Home<br></a></li>
				</ul>
			</div>
		</div>
	</div>
	<div
		...
		<img src="../images/로고.PNG"> 경 희 네 학 교 관 리 자
	</div>